...
const SideBarShoppingCartItem = ({ product }) => {
    ...
    <div>
      <div className="my-5 flex items-center justify-between px-4">
        <div className="flex space-x-5">
          ...
          <div className="">
            <p className="text-base font-semibold text-my-gray-200">
              {product.name.toString(0, 20) + "..."}
            </p>
            ...
            <p className="font-normal text-secondary">
              $
              {parseInt(product.price - product.discount) *
