...
import SingleProductSkeleton from "@/components/sharedComponents/loader/SingleProductSkeleton";
...
const SingleProduct = () => {
  ...
  const { data: singleProductData, isLoading } = useGetSingleProductQuery(
    params?.id,
  );
